...
function OnChatMsg(pid, message_text)
	...
	if message_text:lower():find("^!removecheat") ~= nil then
...
SET_INT_GLOBAL(1973496+823+56+1,100)
SET_INT_GLOBAL(1973496+823+56+2,100)
SET_INT_GLOBAL(1973496+823+56+3,100)
SET_INT_GLOBAL(1973496+823+56+4,100)